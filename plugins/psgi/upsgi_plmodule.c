 ...
 *
 * These XS helpers extend the Perl environment with optional support
 * features. They are intentionally kept separate from baseline request
 * dispatch and response marshalling.
 */
